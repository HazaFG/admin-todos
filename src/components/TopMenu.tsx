      ...
      <div className="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5 border border-gray-200 ">
        ...
        <div className="px-6 flex items-center justify-between space-x-4">
          ...
          <div className="flex space-x-2">
            ...
            <button className="p-2 flex items-center justify-center h-10 rounded-xl border border-gray-300 bg-gray-100 focus:bg-gray-100 active:bg-gray-200">
              {
                totalItems > 0 && (<span className='text-sm mr-2 text-red-500 font-bold'>{totalItems}</span>)
              }
